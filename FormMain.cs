...
namespace _1612180_1612677
{
    public partial class FormMain : Form
    {
        ...
        private const int MAX_OF_MY_SHAPES_STACK = 4;
        //luu vi tri hien tai cua redo
        ...
        // luu cac danh sach hinh cu va moi dung de undo va redo
        private List<List<MyShape>> stackMyShape = new List<List<MyShape>>();
        ...
        public void AddObjectToMyShape(MyShape myshape)
        {
            ...
            {
                for (int i = stackMyShape.Count - 1; i >= indexOfMyShapes + 1; i--) 
                {
                    stackMyShape.RemoveAt(i);
                }
                indexOfMyShapes++;
            }

            myShapes.Add(myshape);
            stackMyShape.Add(new List<MyShape>(myShapes));
        }
        ...
        private void buttonUndo_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                myShapes = new List<MyShape>(stackMyShape[indexOfMyShapes]);
            }
            clearBitmap();
            wrapDrawAllShapes(bitmap_primary);
            isUndo = true;
        ...
        {
            if ((indexOfMyShapes == MAX_OF_MY_SHAPES_STACK)  || indexOfMyShapes == -1 || indexOfMyShapes == stackMyShape.Count -1)
                return;
            else
            {
                indexOfMyShapes = indexOfMyShapes + 1;
